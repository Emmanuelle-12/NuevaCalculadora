...
public class Cliente1 {
   public static void main(String[] args){
       ...
       try{
           Registry miRegistro = LocateRegistry.getRegistry("127.0.0.1", 1099);
           Calculadora c = (Calculadora)Naming.lookup("//127.0.0.1/Calculadora");
               ...
               String menu = JOptionPane.showInputDialog("Calculadora"
                  ...
                  switch(menu){
                      ...
                      case "4":{
                          ...
                          if(y == 0){
                              JOptionPane.showMessageDialog(null, "No se puede divirdir por cero.");
